...
from insert_data_into_mysql import insert_data_into_mysql
...
# === File Path ===
data_dir = "C:/Users/Haroon/Documents/GitHub/FHIR-task/data/"
...
def write_sql_create_table_statements():   
    sql_dir = "./sql_tables"
...
def create_csv_files_and_insert_data_into_mysql_db():
    ...
    for resource_type, records in resource_map.items():
        ...
        table_name = resource_type.lower()
        # insert data into mysql
        insert_data_into_mysql(mysql_connection,df,table_name)
...
write_sql_create_table_statements()    
create_csv_files_and_insert_data_into_mysql_db()
